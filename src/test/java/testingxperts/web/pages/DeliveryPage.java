...
public class DeliveryPage extends HomePage{
	...
	public static By inputCity_New_Address=By.id("new-city");
	...
	public static boolean addNewAddress(String fullName, String address, String country,String state,String city, String pin,String mobile) throws InterruptedException{
		...
		catch(Exception e)
		{
			...
			if(country!="India")
			{
				inputText(inputState_NewAddress, state);
				pressTabKey(inputState_NewAddress);
				pause(1000);

				inputText(inputCity_New_Address, city);
				pressTabKey(inputCity_New_Address);
				pause(3000);
	...
	public static boolean selectCountryAddress(String country)
	{
		return click(By.xpath("//div[contains(@id,'address-card')]/div[child::p[text()='"+country+"']]/following-sibling::a[text()='Deliver Here']"));
	}

...
public class IGP_TC_247 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Fixed time delivery:Ensure that the user selects the Fixed time delivery option."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Select Fixed Time delivery option.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.enterFixedTimeDelivery(9, "Next Month"), stepInfo);

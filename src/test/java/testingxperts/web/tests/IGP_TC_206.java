...
public class IGP_TC_206 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_206",
			groups={"Payment"}, 
			description="Net Banking: Ensure that Net Banking option in Payment page."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			logStep(stepInfo);
			verifyStep(PaymentPage.verifyNetBankingPage(),stepInfo);
			pause(2000);

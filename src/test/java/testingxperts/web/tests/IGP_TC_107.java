...
public class IGP_TC_107 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Zoom in feature on the image:Ensure that when the user  mouse hover on image, it Should zoom in."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Mouse hover on the image.";
			logStep(stepInfo);

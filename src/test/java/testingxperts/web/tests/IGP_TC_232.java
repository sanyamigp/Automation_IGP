...
public class IGP_TC_232 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_232",
			groups={"Product List"}, 
			description="Navigate to Product Listing page:User is able to see all the details on Product Listing Page for Birthday Card."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Open Birthday Page for Women";
			logStep(stepInfo);
			ProductList.openBirthdayListPage();
			verifyStep(ProductList.isBirthdayPageLoaded(), stepInfo);

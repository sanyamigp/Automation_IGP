...
public class IGP_TC_110 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Need Help?:Ensure that user able to send query by clicking on 'Need Help' from the Product Description page."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Click on 'Need Help?'.";
			verifyStep(ProductDetailPage.needHelpOption("Need more information about product(s)", "Wrong Information"), stepInfo);
			pause(3000);

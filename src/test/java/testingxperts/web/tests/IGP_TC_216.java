...
public class IGP_TC_216 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_216",
			groups={"Payment"}, 
			description="Wallets: MOBIKWIK- : Ensure that  MOBIKWIK  option in Wallets section."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Verify when user select Payment option Wallets MOBIKWIK and click make payment. User should navigate to MOBIKWIK page";
			logStep(stepInfo);
			PaymentPage.makePaymentWithWallet(Wallets.MOBIKWIK);
			pause(6000);
			String currentUrl =getCurrentUrl();
			verifyStep(currentUrl.contains("walletapi.mobikwik.com"), stepInfo);

...
public class IGP_TC_252 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Buy Now: Check the functionality of Buy Now button."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check the footer content at the bottom of the page.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.footerContent(), stepInfo);
			pause(3000);
			
			stepInfo="Enter the valid pincode in the textbox and check.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifypincode("134116"), stepInfo);
			pause(3000);
			
			stepInfo="Click on Buy Now button.";
			logStep(stepInfo);
			ProductDetailPage.verifyclikBuyNowbutton();
			pause(2000);
			verifyStep(CartPage.isCartPageLoaded(), stepInfo);
			
			String elementSShot=takeScreenshotWebElement(waitForVisibile(By.className("cart-container")),"Cart page");

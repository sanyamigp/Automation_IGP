	...
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Verify Click on payment options respective tab should open";
			logStep(stepInfo);
			
			stepInfo="Verify credit card option";
			verifyStep(
			PaymentPage.verifyPaymentOptionIsDisplayed(PaymentPage.PaymentOptions.CREDIT_CARD),
			stepInfo);
			pause(1000);
			
			PaymentPage.clickPaymentOption(PaymentPage.PaymentOptions.DEBIT_CARD);
			stepInfo="Verify debit card option";
			verifyStep(
			PaymentPage.verifyPaymentOptionIsDisplayed(PaymentPage.PaymentOptions.DEBIT_CARD),
			stepInfo);
			pause(1000);

...
public class IGP_TC_246 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Fixed Date delivery:Ensure that the user selects the Fix Date delivery option."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Select Fixed Date delivery option.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.enterFixedDateDelivery(5,"Next Month"), stepInfo);

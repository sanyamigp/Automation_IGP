...
public class IGP_TC_213 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_213",
			groups={"Payment"}, 
			description="Wallets - Verify Wallets option in Payment page"
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			String elementSShot=takeScreenshotWebElement(waitForVisibile(By.cssSelector(".payment-block")),"PaymentMethods_Wallets");

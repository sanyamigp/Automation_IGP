...
public class IGP_TC_258 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_258",
			groups={"Cart"}, 
			description="Chat Feature: Ensure that chat pop-up window appears."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Click on 'Chat with us Now' link.";
			logStep(stepInfo);
			verifyStep(CartPage.verifyChatPopUp(), stepInfo);

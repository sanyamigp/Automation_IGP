	...
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Click on 'Net Banking'.";
			logStep(stepInfo);
			PaymentPage.verifyNetBankingPage();
			verifyStep(PaymentPage.verifyNetBankingoptions("ICIB"),stepInfo);
			
			
			String elementSShot=takeScreenshotWebElement(waitForVisibile(By.xpath(".//*[@id='payment']/div")),"Net Banking options");

...
public class IGP_TC_249 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Product Description tab: Verify that Product Description tab is visible."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Verify the Product Description tab's contents.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyProductDescriptionTab(), stepInfo);
			pause(3000);

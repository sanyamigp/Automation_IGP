...
public class IGP_TC_255 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Choose Type of Base: Ensure that user select the base."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Choose different types of base.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.chooseBaseType(), stepInfo);

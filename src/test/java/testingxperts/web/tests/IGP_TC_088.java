...
public class IGP_TC_088 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Apply Coupon Code:Ensure that the user able to apply coupon code."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Click here to Apply link";
			OrderSummaryPage.clickApplyCoupen();
			
			stepInfo="Enter the valid coupon code";
			verifyStep(OrderSummaryPage.validatecouponcoderesult("IGP15"),stepInfo);

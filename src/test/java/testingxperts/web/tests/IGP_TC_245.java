...
public class IGP_TC_245 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Delivery Options visibility: All the 3 delivery options should be visbile."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check all the delivery options in the PDP.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyDeliveryOptions(), stepInfo);

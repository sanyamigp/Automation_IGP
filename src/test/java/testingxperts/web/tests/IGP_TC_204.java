...
public class IGP_TC_204 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_204",
			groups={"Payment"}, 
			description="Payment Page-Credit Card & Debit card: Ensure that  Make Payment button has to display  pay amount  before clicking it."
			)

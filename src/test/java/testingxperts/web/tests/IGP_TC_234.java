...
public class IGP_TC_234 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_234",
			groups={"Product List"}, 
			description="Navigate to Product Listing page:User is able to see all the details on Product Listing Page for Anniversary Gifts."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Open Anniversary Gifts Page for Women";
			logStep(stepInfo);
			ProductList.openAnniversaryGifts();

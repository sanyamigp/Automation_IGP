...
public class IGP_TC_254 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Product variety: Ensure that user select product with different varities."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Select product with different varities.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyProductVariety(), stepInfo);
			
			String elementSShot=takeScreenshotWebElement(waitForVisibile(By.xpath(".//*[@id='site-wrapper']/section[1]/div[2]/div")),"Product Description Page");

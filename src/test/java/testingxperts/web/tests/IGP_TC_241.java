...
public class IGP_TC_241 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Fields are present: Ensure that all the respective fields should be visible."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="User should be able to see the following fields on PDP page: Breadcrumbs";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyBreadcrumbs(), stepInfo);
			
			stepInfo="User should be able to see the following fields on PDP page: Name of the Product";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyProductName(), stepInfo);
			
			stepInfo="User should be able to see the following fields on PDP page: Price of the Product";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyProductPrice(), stepInfo);

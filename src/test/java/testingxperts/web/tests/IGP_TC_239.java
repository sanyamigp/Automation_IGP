...
public class IGP_TC_239 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_239",
			groups={"Card List"}, 
			description="Navigate to Card List page:User is able to see all the details on Card List Page for Gifts for Women."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			logStep(stepInfo);
			ProductStripPage.openStripPage("gifts-for-women");
			verifyStep(ProductStripPage.isStripPageLoaded("Gifts for Women"), stepInfo);
			...
			stepInfo="Check the presence of Women Gifts Card.";
			logStep(stepInfo);

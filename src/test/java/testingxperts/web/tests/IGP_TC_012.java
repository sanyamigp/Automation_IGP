...
public class IGP_TC_012 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_012",
			groups={"Home"}, 
			description="SignUp:Duplicate Email Id/Number."
			)
	public void test() throws Throwable {
		try{
			...
			stepInfo="Enter the duplicate sign-up details.";
			logStep(stepInfo);
			verifyStep(LoginPage.duplicateSignUpDetails(), stepInfo);
			pause(3000);


			String elementSShot=takeScreenshotWebElement(waitForVisibile(By.xpath(".//*[@id='sign-up-1']")),"SignUpPage");

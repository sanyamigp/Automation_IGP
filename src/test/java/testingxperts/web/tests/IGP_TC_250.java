...
public class IGP_TC_250 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Similar Gift Recommendations: Verify that Similar Gift Recommendations heading is visible."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check Similar Gift Recommendations heading is visible.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.headerVisible(), stepInfo);
			pause(3000);

...
public class IGP_TC_242 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Check Image fields: Ensure that image fields are present."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check whether the image of the product is visible.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyProductImage(), stepInfo);
			
			stepInfo="Check that the image is seen on different angles of the thumbnails.";
			logStep(stepInfo);

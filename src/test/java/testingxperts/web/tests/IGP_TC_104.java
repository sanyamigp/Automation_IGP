...
public class IGP_TC_104 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Delivery Area Pin code validation: Ensure that error message is coming for places where delivery is not supported."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Enter invalid pin code where the delivery is not supported.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifydeliverylocation("123456"), stepInfo);
			pause(3000);

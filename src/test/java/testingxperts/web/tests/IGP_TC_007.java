...
public class IGP_TC_007 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			testName="IGP_TC_007",
			groups={"Sanity"}, 
			description="Check whether user is able to make payment for Card List Page for Birthday."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Check whether Birthday Page is opened.";
			logStep(stepInfo);
			HomePage.selectOptionFromBirthday(1);

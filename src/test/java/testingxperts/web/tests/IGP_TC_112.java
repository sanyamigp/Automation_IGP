...
public class IGP_TC_112 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Personalized Now-:Ensure  that Personalized now button should display when user select the personalized product only."
			)

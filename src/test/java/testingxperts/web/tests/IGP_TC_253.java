...
public class IGP_TC_253 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Add to Cart: Ensure that the product is added to cart upon clicking 'Add to cart' button."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			logStep(stepInfo);
			CartPage.selectItemToBuy(GiftBy.FLOWER_AND_CAKE);
			pause(3000);
			...
			String elementSShot=takeScreenshotWebElement(waitForVisibile(By.id("c-mask")),"Product Description Page");

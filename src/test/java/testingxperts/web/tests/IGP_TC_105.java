...
public class IGP_TC_105 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="International shipping: 'Enter Country name' field: Ensure that Enter Country name field should not accept numbers & special symbols."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Click on 'International shipping'.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.clickinternationalshipping(), stepInfo);
			
			stepInfo="Enter invalid data in 'country name'.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.enterInvalidcountry(Constants.INVALID_COUNTRY), stepInfo);
			pause(3000);

...
public class IGP_TC_108 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Product name and Price:Ensure that the selected product name and price should be same with what we are selected in listing page."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Navigate to product description page.";
			logStep(stepInfo);
			verifyStep(ProductDetailPage.verifyNamendPrice(2), stepInfo);
			pause(3000);

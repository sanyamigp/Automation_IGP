...
public class IGP_TC_236 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Navigate to Product Strip page:User is able to see all the details on Product Strip  Page for a country."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Open Country Page";
			logStep(stepInfo);
			ProductStripPage.openStripPage("usa");
			verifyStep(ProductStripPage.isStripPageLoaded("USA"), stepInfo);
